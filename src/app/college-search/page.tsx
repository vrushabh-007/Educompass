...
const logoMap: Record<string, string> = {
  'Massachusetts Institute of Technology': 'https://picsum.photos/seed/mit-logo/56/56',
  'Stanford University': 'https://picsum.photos/seed/stanford-logo/56/56',
  'Harvard University': 'https://picsum.photos/seed/harvard-logo/56/56',
  'University of Cambridge': 'https://picsum.photos/seed/cambridge-logo/56/56',
  'University of Oxford': 'https://picsum.photos/seed/oxford-logo/56/56',
  'California Institute of Technology': 'https://picsum.photos/seed/caltech-logo/56/56',
  'ETH Zurich': 'https://picsum.photos/seed/eth-logo/56/56',
  'University College London': 'https://picsum.photos/seed/ucl-logo/56/56',
  'Imperial College London': 'https://picsum.photos/seed/imperial-logo/56/56',
  'University of Chicago': 'https://picsum.photos/seed/chicago-logo/56/56',
  'University of California, Berkeley': 'https://picsum.photos/seed/berkeley-logo/56/56',
  'National University of Singapore': 'https://picsum.photos/seed/nus-logo/56/56',
  'Princeton University': 'https://picsum.photos/seed/princeton-logo/56/56',
  'University of Tokyo': 'https://picsum.photos/seed/tokyo-logo/56/56',
  'Yale University': 'https://picsum.photos/seed/yale-logo/56/56',
};
